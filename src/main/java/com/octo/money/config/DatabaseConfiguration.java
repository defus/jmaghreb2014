...
@Configuration
@EnableJpaRepositories("com.octo.money.repository")
...
public class DatabaseConfiguration implements EnvironmentAware {
    ...
    @ConditionalOnMissingClass(name = "com.octo.money.config.HerokuDatabaseConfiguration.class")
    ...
    public List<String> getBasePackages() {
        ...
        basePackages.add("com.octo.money.domain");
        return basePackages;
    }
